...
datapath = r"\\Chfile1\ecs_landrive\Automotive_Lighting\LED\Tesla Model 3\DVPR\PV\De-rating\Combined Env & HTHE\!RawData"
...
test = TestStation('Tesla Combined Current Derating Test Data', boards, datapath, limits, run_limits, multimode, *temps)
